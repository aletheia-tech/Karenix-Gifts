---
layout: product
title: Sitting Duck Everyday Socks
item-id: sitting-duck-everyday-socks
image_path: ../../../images/novelty-items/sitting-duck-everyday-socks.jpg
category: [novelty-items, socks]
permalink: /products/novelty-items/sitting-duck-everyday-socks/
description: "A favorite toy, through the ages. Timeless rubber duckies float on an aqua background."
price_usd: 7.41
price_ttd: 50
...
<div class="flex flex-wrap">
  ...
  <div class="sm:flex-1">
    <p class="p-4 text-gray-700">
      {{ page.description }}
      <br><br>
      Yellow toes and heels keep this pair happy and simple.
