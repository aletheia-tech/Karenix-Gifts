...
<h1 class="text-center text-2xl text-blue-700 tracking-wider">Serveware</h1>
</div>

<div class="flex flex-wrap min-w-0 max-w-full lg:px-16 p-4 justify-evenly">
  {% assign serveware = site.products | where: "categories", "serveware" %}
  {% for product in serveware %}
