...
layout: tailwind
title: Novelty Items
permalink: /novelty-items/
---

<div class="container mx-6 mt-6 p-8 mx-auto">
<h1 class="text-center text-2xl text-blue-700 tracking-wider">Novelty Items</h1>
</div>

<div class="flex flex-wrap min-w-0 max-w-full lg:px-16 p-4 justify-evenly">
  {% assign novelty-items = site.products | where: "categories", "novelty-items" %}
  {% for product in novelty-items %}
